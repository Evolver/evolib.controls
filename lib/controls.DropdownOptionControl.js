	...
	{//create dropdown container object
		...
		{// create tools object
			...
			if( multi) {
				...
				lib.event.bind( tool, 'click', tool.__clickHandler =function( e){
...
p.unloadDropdownOptionControl =function() {
	...
	if( this.multi) {
		lib.event.unbind( this.dropdown.toolsContainer.selectDeselectContainer, 'click', this.dropdown.toolsContainer.selectDeselectContainer.__clickHandler);
	}
	
	lib.event.unbind( this.dropdown.toolsContainer.closeContainer, 'click', this.dropdown.toolsContainer.closeContainer.__clickHandler);
