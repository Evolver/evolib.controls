		...
		{// create alphabet container
			...
			{// create tool container
				...
				{// create 'show all' tool
					...
					lib.attr.set( tool, {
						'title': 'Show all',// FIXME: i18n
						'class': 'all'
					});
					lib.html.set( tool, 'Show all');// FIXME: i18n
		...
		{// create tool container
			...
			if( multi) {
				{// create 'select-all' tool
					...
					lib.attr.set( tool, {
						'title': 'Check all',// FIXME: i18n
						'class': 'check-all'
					});
					lib.html.set( tool, 'Check all');// FIXME: i18n
				...
				{// create 'deselect-all' tool
					...
					lib.attr.set( tool, {
						'title': 'Uncheck all',// FIXME: i18n
						'class': 'uncheck-all'
					});
					lib.html.set( tool, 'Uncheck all');// FIXME: i18n
			...
			{// create 'close' tool
				...
				lib.html.set( tool, 'Close');// FIXME: i18n
